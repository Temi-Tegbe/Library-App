...
namespace NEWCustomerOnboarding.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<IActionResult> RegisterAdmin([FromBody] CustomerRegistrationDTO model)
        {
        ...
        public async Task<IActionResult> AuthorizeAdmin([FromBody] CustomerLoginDTO request)
        {
